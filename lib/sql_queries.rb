...
"SELECT projects.category, SUM(pledges.amount) FROM projects INNER JOIN projects ON pledges ON projects.id = pledges.project_id WHERE projects.category = 'books' "
end
